...
int main() {
    ...
    // Professores
    Professor prof1("Katia Barbosa", 60, "Matematica");
    Professor prof2("Cristiane Balieiro", 44, "Portugues");
    Professor prof3("Paulo Medeiros", 44, "Ingles");
    Professor prof4("Anusa Patricia", 34, "Historia");
    Professor prof5("Deylla Garcez", 40, "Filosofia");
    Professor prof6("Cleise Aquino", 30, "Biologia");
    Professor prof7("Lorena Campos", 30, "Quimica");
    Professor prof8("Lucas Marinho", 30, "Fisica");
    Professor prof9("Andreza Souza", 30, "Artes");
    Professor prof10("Deylla Garcez", 30, "Sociologia");
    Professor prof11("Denilson Silva", 40, "Geografia");
    Professor prof12("Paulo Medeiros", 40, "Linguagens");
    Professor prof13("Andreza Souza", 30, "Ed.Fisica");
    Professor prof14("Katia Barbosa", 60, "Letramento Matematico");
    Professor prof15("Priscila Goncalves", 20, "EPAEM");
    ...
    Aluno a1("Ana Ester", 14, 101);
    Aluno a2("Ana Julia", 15, 102);
    Aluno a3("Josue Argenis", 16, 103);
    Aluno a4("Bruno Simoes", 16, 104);
    Aluno a5("Edma", 14, 105);
    Aluno a6("Francinei", 16, 106);
    Aluno a7("Francisco", 15, 107);
    Aluno a8("Gustavo William", 15, 108);
    Aluno a9("Helio", 15, 109);
    Aluno a10("Henrique", 15, 110);
    Aluno a11("Jhonata", 15, 111);
    Aluno a12("Joao", 15, 112);
    Aluno a13("John", 15, 113);
    Aluno a14("Julita", 15, 114);
    Aluno a15("Leo", 15, 115);
    Aluno a16("Maria Eduarda", 15, 117);
    Aluno a17("Maria Luiza", 16, 118);
    Aluno a18("Miguel", 15, 119);
    Aluno a19("Nayanne", 15, 120);
    Aluno a20("Nicole Beatriz", 16, 121);
    Aluno a21("Otavio", 17, 122);
    Aluno a22("Shymenne", 17, 123);
    Aluno a23("Vitoria", 15, 124);
    Aluno a24("Yasmin", 16, 125);
